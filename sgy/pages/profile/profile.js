...
// 关于本工具 · 近期更新（发版时手动加一行，最新在最前）
// 注：0.4.0 / 0.5.0 两次上传没有用户可见变化（是被拒后改而重提审核、版本号跟着涨），故无对应条目——
// 顶端三条属于 0.6.0，其下六条属于 0.3.0 及更早。
const CHANGELOG = [
  "集合口令：每局给一组 4 位数字——到场对一句口令认人；想在微信建群，几个人在「面对面建群」输同一组数字即可",
  "出发前提醒：快到点的局，打开小程序会提醒你按时到达；赶不上请及时退出，别让队友扑空",
  "修复加急局：之前「勾加急」和「选时间」互相等待，加急局一直发不出去；现已正常",
  "取消站内聊天：队伍沟通改为到点集合见人，车费线下当面对付（无聊天室 Tab）",
